  ...
  return (
    <DialogPortal>
      ...
      <DialogPrimitive.Popup
        ...
        {...props}
      >
        {/* Scrolls as one region once content exceeds max-h-[85vh]; the close
            button below lives outside this wrapper so it stays pinned to the
            corner instead of scrolling away with the form. */}
