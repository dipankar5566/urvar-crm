    ...
    <Dialog open={open} onOpenChange={setOpen}>
      ...
      <DialogContent>
        ...
        <p className="text-sm text-muted-foreground">
          The invoice is not deleted — its ledger entry is reversed and the invoice is marked
          cancelled. This cannot be undone from here; a new invoice would need to be raised again.
        </p>
