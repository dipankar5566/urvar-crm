...
import { itemWiseProfitAndLoss } from "@/lib/accounting/financial-reports";
...
export default async function ItemProfitLossPage({
  searchParams,
}: {
  ...
  const rows = await itemWiseProfitAndLoss(fromDate, toDate);

  return (
    <div className="space-y-6">
      <PageHeader title="Item Wise Profit and Loss" subtitle="Revenue and estimated cost per product over a date range." />
