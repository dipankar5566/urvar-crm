...
import { itemCategoryWiseProfitAndLoss } from "@/lib/accounting/financial-reports";
...
export default async function ItemCategoryProfitLossPage({
  searchParams,
}: {
  ...
  const rows = await itemCategoryWiseProfitAndLoss(fromDate, toDate);

  return (
    <div className="space-y-6">
      <PageHeader title="Item Category Wise Profit and Loss" subtitle="Revenue and estimated cost per product category over a date range." />
