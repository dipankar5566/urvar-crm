...
import { discountReport } from "@/lib/accounting/financial-reports";
...
export default async function DiscountReportPage({
  ...
  const rows = await discountReport(fromDate, toDate);

  return (
    <div className="space-y-6">
      <PageHeader title="Discount Report" subtitle="Discount given per customer over a date range." />
